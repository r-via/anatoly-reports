...
- [x] [shard.1.md](./shard.1.md) (10 files — 5 CRITICAL, 5 NEEDS_REFACTOR)
- [ ] [shard.2.md](./shard.2.md) (10 files — 10 NEEDS_REFACTOR)
- [ ] [shard.3.md](./shard.3.md) (7 files — 7 NEEDS_REFACTOR)
...
Finds bugs, logic errors, incorrect types, and unsafe operations. Only flags real correctness issues, not style.
...
*Generated: 2026-03-25T11:09:23.557Z*
